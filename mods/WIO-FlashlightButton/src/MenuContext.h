...
namespace FMB::MenuContext
{
	...
	public:
		...
		static void Install()
		{
			...
			s_installed = true;
			REX::INFO("Flashlight Button: crosshair-target watcher installed"sv);
		}
	...
	public:
		static void Install()
		{
			...
			s_installed = true;
			REX::INFO("Flashlight Button: crosshair-mode watcher installed"sv);
		}
