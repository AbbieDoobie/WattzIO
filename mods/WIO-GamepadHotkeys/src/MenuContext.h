...
namespace GMH::MenuContext
{
	...
	public:
		...
		static void Install()
		{
			...
			s_installed = true;
			REX::INFO("Gamepad MCM Hotkeys: crosshair-target watcher installed"sv);
		}
	...
	public:
		static void Install()
		{
			...
			s_installed = true;
			REX::INFO("Gamepad MCM Hotkeys: crosshair-mode watcher installed"sv);
		}
	...
	[[nodiscard]] inline State Capture()
	{
		...
		state.pausingMenuOpen = !ui || ui->menuMode != 0;
