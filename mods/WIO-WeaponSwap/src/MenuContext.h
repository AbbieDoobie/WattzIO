...
namespace WS::MenuContext
{
	...
	public:
		...
		static void Install()
		{
			...
			s_installed = true;
			REX::INFO("Weapon Swap Button: crosshair-target watcher installed"sv);
		}
	...
	public:
		static void Install()
		{
			...
			s_installed = true;
			REX::INFO("Weapon Swap Button: crosshair-mode watcher installed"sv);
		}
